...
then
    ...
    python ../PrivDNN/main.py --dataset $dataset --model_work_mode 1 --train_dataset_percent 100 --top_k_accuracy ${top_k_accuracy[$dataset]}
elif [[ $function == 'test' ]]
then
    # test the normal model performance
    python ../PrivDNN/main.py --dataset $dataset --model_work_mode 2 --top_k_accuracy ${top_k_accuracy[$dataset]}
...
then
    ...
    python ../PrivDNN/main.py --dataset $dataset --model_work_mode 4 --recover_dataset_count 1000  --top_k_accuracy ${top_k_accuracy[$dataset]}
elif [[ $function == 'inference' ]]
then
    # inference the model in the cipher domain with the SEAL library
    python ../PrivDNN/main.py --dataset $dataset --model_work_mode 5 --top_k_accuracy ${top_k_accuracy[$dataset]}
elif [[ [$dataset == 'clean'] || [$function == 'clean'] ]]
then
